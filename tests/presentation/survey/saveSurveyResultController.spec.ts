...
import { mockDate, mockSaveSurveyResultRequest, mockSurveyResult, throwError } from '@/tests/mocks'
...
describe('SaveSurveyResult Controller', () => {
    ...
    test('Should call LoadSurveyById with correct values', async () => {
        ...
        await sut.handle(mockSaveSurveyResultRequest())
    ...
    test('Should return 403 if LoadSurveyById returns null', async () => {
        ...
        const httpResponse = await sut.handle(mockSaveSurveyResultRequest())
